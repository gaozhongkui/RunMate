        ...
        VStack(spacing: 28) {
            ...
            VStack(spacing: 16) {
                HStack(spacing: 10) {
                    ...
                    Text("home_scanning_title").font(AppTheme.Fonts.headline()).foregroundColor(AppTheme.Colors.textPrimary)
                }
                statusLabels
            }
        }
